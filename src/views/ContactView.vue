  ...
  <div class="flex justify-center items-center h-screen bg-white">
	...
	<div class="container mx-auto my-4 px-4 lg:px-20">
		...
		<div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
			<div class="flex">
				<h1 class="font-bold uppercase text-5xl">Phản hồi cho chúng tôi</h1>
			</div>
			...
			<div
				...
				<div class="flex flex-col text-white">
					<h1 class="font-bold uppercase text-4xl my-4">Cơ sở chính</h1>
            ...
            <div class="flex flex-col">
              <h2 class="text-2xl">Cơ sở chính</h2>
              <p class="text-gray-400">666 Hoàng Mike, Hà Nội</p>
            </div>
          </div>
          ...
          <div class="flex my-4 w-2/3 lg:w-1/2">
            ...
            <div class="flex flex-col">
              <h2 class="text-2xl">Gọi cho chúng tôi</h2>
